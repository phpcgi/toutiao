...
use app\common\model\UserFlux as usermodel;
use app\common\model\UserFluxtid as userextmodel;
use fast\Random;
use fast\Tree;
use think\Validate;
use think\Cookie;
...
class Userflux
{
    ...
    public static function ext($data,$uid){
        $dataext['uid'] = $uid;
        ...
        $add = userextmodel::create($dataext);
        if ($add){
            return 1;
        }
    }
