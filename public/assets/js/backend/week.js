    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                ...
                sortOrder: 'desc',
                extend: {
                    index_url: 'week/index',
                    add_url: 'week/add',
                    edit_url: 'week/edit',
                    del_url: 'week/del',
                    multi_url: 'week/multi',
                    table: 'data_week',
                }
            });
        ...
        api: {
            ...
            formatter: {
                dome: function () {
                   // return document.getElementById("groupdata").value;
...
//
// var a=document.getElementById("groupdata").value;
// alert(a)

//    var selectValue=t.options[t.selectedIndex].value;//获取select的值
//alert(selectValue);
//    alert(document.getElementsByName("type").value);
//    document.getElementsByName("type").append("<option value='Value'>Text</option>");
