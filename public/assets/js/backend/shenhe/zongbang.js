    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                search: false,
                extend: {
                    index_url: 'monthlist/zongbang/index',
                    add_url: 'monthlist/zongbang/add',
                    edit_url: 'monthlist/zongbang/edit',
                    del_url: 'monthlist/zongbang/del',
                    multi_url: 'monthlist/zongbang/multi',
                    table: 'data_month',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'description', title: __('　　　描　述　　　'), operate: 'LIKE %...%', placeholder: '描述，模糊搜索，*表示任意字符', style: 'width:200px',
                            process: function (value, arg) {
                                return value.replace(/\*/g, '%');
                            }
                        },                        
                        {field: 'Avatar_url', title: __('Avatar_url'), formatter: Controller.api.formatter.thumb},
