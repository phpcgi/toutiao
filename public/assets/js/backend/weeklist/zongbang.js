    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                ...
                sortOrder: 'desc',
                extend: {
                    index_url: 'weeklist/zongbang/index',
                    add_url: 'weeklist/zongbang/add',
                    edit_url: 'weeklist/zongbang/edit',
                    del_url: 'weeklist/zongbang/del',
                    multi_url: 'weeklist/zongbang/multi',
                    table: 'data_week',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        // {field: 'A5_sort', title: __('A5_sort'), operate: false},
