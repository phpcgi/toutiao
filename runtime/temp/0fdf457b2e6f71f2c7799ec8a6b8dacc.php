<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"D:\www\toutiaodata\public/../application/index\view\toutiao\index.html";i:1515216378;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
		<title>又又又又</title>
		<link rel="stylesheet" href="__CDN__/assets/css/index/login.css" />
	</head>
			<style>
	...
	<body>111111111111111111
		...
		<div id="con">
			<div class="con_c">
				...
				<div class="zs">
					<!--<p class="zzs">*注：如果在旧版头条易平台提交过信息，初次登录新版平台，请点击“忘记密码”</p>-->
				</div>
				<div class="denglu">
					<p class="dl">登录</p>
				</div>
				<div class="meiyou">
					<p class="my chuang">还没有自己的账号？现在创建一个吧</p>
				</div>
			</div>
		</div>
		<div id="footer">
	...
	<script type="text/javascript" src="__CDN__/assets/js/index/js/index.js" ></script>
	<script>
		var a=true;
