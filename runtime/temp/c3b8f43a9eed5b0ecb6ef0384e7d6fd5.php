<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:62:"D:\toutiao\public/../application/index\view\toutiao\g_scj.html";i:1515128416;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
		...
		<link rel="stylesheet" href="__CDN__/assets/css/index/g_scj.css" />
		...
		<div id="g_head">
			<div class="g_head">
				...
				<ul class="g_con">
					...
					<li>
						<div class="li_l">
							<img src="__CDN__/assets/img/xmtxy/shoucangjia-dangqian.png" />
						</div>
	...
	<script type="text/javascript" src="__CDN__/assets/js/index/js/g_scj.js" ></script>
