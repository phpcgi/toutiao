<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"D:\www\toutiaodata\public/../application/index\view\toutiao\shouye.html";i:1515128423;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
	...
	<body>
		...
		<div id="hezuo">
			<div class="hezuo">
				...
				<div class="hezuo_c">
					<!--<p class="hezuo_j">&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;奇偶奥 爱发哦 i 发哦死对方啊决定是否 i 觉得撒家粉丝都 搜佛哦啊申建搭配啊申建都佛啊就是打破费劲啊拍摄阿斯顿发就是发生发阿斯顿发上 骄傲啊就是对佛教阿松ID放假哦啊到司机佛啊申建都费劲啊都送积分啊就是佛啊就是东方骄傲申建佛啊撒佛 i 阿松 i</p>-->
				</div>
				<ul class="hezuo_b">
				...
				<div class="lianx_b">
					<div class="lianxb_l">
						...
						<div class="email dizhi">
							...
							<p class="email_r">地址：北京市东城区灯市口大街国中商业大厦1207室</p>
						</div>
					</div>
				<div class="lianxb_r">
					<div class="lianxbr_l">
