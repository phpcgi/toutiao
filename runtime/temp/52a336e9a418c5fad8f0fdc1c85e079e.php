...
<html>
	<head>
		<meta charset="UTF-8">
		<title></title>
		<link rel="stylesheet" href="__CDN__/assets/css/index/regaster.css" />
		<style>
			...
			<div class="content">
				...
				<div class="content_c">
					...
					<div class="content_n">
						...
						<input class="name_s t_name" required="required"  type="text" />
					</div>
					<div class="content_n ct">
						<div class="name_k">
							<p class="name">头条号主页链接</p>
							<p class="name lianj">(请输入正确的链接)</p>
						</div>
						<input class="name_s link" type="text" />
					</div>
					<p class="yl yl2">查看样例</p>
					<div class="content_n ct">
						<div class="name_k">
							<p class="name">头条号管理后台截图</p>
							<p class="name ctu">(请输入正确的链接)</p>
						</div>
						<form id="form1" enctype="multipart/form-data" class="beijing">
						<div class="cbg"></div>
						<input class="name_s chuan" name="file" type="file" placeholder="本地上传"  />
						</form>
					</div>
					<p class="yl yl1">查看样例</p>
					<div class="content_n cy">
						<div class="name_k">
							<p class="name">是否支持撰稿</p>
						</div>
						<div class="name_s">
							<input class="xuan" type="radio" name="a" value="1" checked="checked" />
							<p class="yes">是</p>
							<input class="ze" type="radio" name="a" value="0" />
							<p class="no">否</p>
						</div> 
					</div>
					<div class="content_n ct">
					...
					<div class="content_n ct">
						...
						<input class="name_s mima1" type="password" onkeyup="value=value.replace(/[^\w|chun]/g,'')" />
						<div class="zhan">
	...
	<script type="text/javascript" src="__CDN__/assets/js/index/js/regaster.js" ></script>
	<script>
		var a=true;
