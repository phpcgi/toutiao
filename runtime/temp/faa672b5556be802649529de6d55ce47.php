<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:63:"D:\toutiao\public/../application/index\view\toutiao\anlixq.html";i:1515128364;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
	...
	<body>
		...
		<div class="title">
			...
			<p class="bt"><?php echo $info['title']; ?></p>
			<!--[英菲尼迪]汽车新闻传播检测报告案例详情-->
		</div>
		<div class="zhan">
	...
	<script src="__CDN__/assets/js/index/js/anlixq.js"></script>
